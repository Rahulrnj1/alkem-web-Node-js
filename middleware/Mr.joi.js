...
const AddMrSchema = async (req, res, next) => {
...
const UpdateMrSchema = async (req, res, next) => {
...
const Mrloginschema = async (req, res, next) => {
...
module.exports = { AddMrSchema, UpdateMrSchema, Mrloginschema }