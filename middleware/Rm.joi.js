...
const rmSchema = async (req, res, next) => {
...
const UpdateRmSchema = async (req, res, next) => {
...
const Rmloginschema = async (req, res, next) => {
...
module.exports = { rmSchema, UpdateRmSchema, Rmloginschema }